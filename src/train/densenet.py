...
class _DenseLayer(nn.Module):
    """DenseNet code, adapted from https://pytorch.org/docs/stable/torchvision/models.html, 
...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
                 num_init_features=64, bn_size=4, drop_rate=0.3, num_classes=4, memory_efficient=False):
